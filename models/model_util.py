...
g_type2class={'Box':0, 'Van':1, 'Truck':2, 'Shelf':3,
              'Person_sitting':4, 'Cyclist':5, 'Tram':6, 'Misc':7}
g_class2type = {g_type2class[t]:t for t in g_type2class}
g_type2onehotclass = {'Box': 0, 'Shelf': 1, 'Cyclist': 2}
g_type_mean_size = {'Box': np.array([3.88311640418,1.62856739989,1.52563191462]),
                    'Van': np.array([5.06763659,1.9007158,2.20532825]),
                    'Truck': np.array([10.13586957,2.58549199,3.2520595]),
                    'Shelf': np.array([0.84422524,0.66068622,1.76255119]),
